 ...
 */
#define YOKAN_MODE_DEFAULT      0b000000000000000
#define YOKAN_MODE_INCLUSIVE    0b000000000000001
#define YOKAN_MODE_APPEND       0b000000000000010
#define YOKAN_MODE_CONSUME      0b000000000000100
#define YOKAN_MODE_WAIT         0b000000000001000
#define YOKAN_MODE_NOTIFY       0b000000000001000
#define YOKAN_MODE_NEW_ONLY     0b000000000010000
#define YOKAN_MODE_EXIST_ONLY   0b000000000100000
#define YOKAN_MODE_NO_PREFIX    0b000000001000000
#define YOKAN_MODE_IGNORE_KEYS  0b000000010000000
#define YOKAN_MODE_KEEP_LAST    0b000000110000000
#define YOKAN_MODE_SUFFIX       0b000001000000000
#define YOKAN_MODE_LUA_FILTER   0b000010000000000
#define YOKAN_MODE_IGNORE_DOCS  0b000100000000000
