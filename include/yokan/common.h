...
#define YOKAN_LAST_VALID_SIZE (ULLONG_MAX-3)
 ...
 */
#define YOKAN_MODE_DEFAULT      0b0000000000000000
#define YOKAN_MODE_INCLUSIVE    0b0000000000000001
#define YOKAN_MODE_APPEND       0b0000000000000010
#define YOKAN_MODE_CONSUME      0b0000000000000100
#define YOKAN_MODE_WAIT         0b0000000000001000
#define YOKAN_MODE_NOTIFY       0b0000000000001000
#define YOKAN_MODE_NEW_ONLY     0b0000000000010000
#define YOKAN_MODE_EXIST_ONLY   0b0000000000100000
#define YOKAN_MODE_NO_PREFIX    0b0000000001000000
#define YOKAN_MODE_IGNORE_KEYS  0b0000000010000000
#define YOKAN_MODE_KEEP_LAST    0b0000000110000000
#define YOKAN_MODE_SUFFIX       0b0000001000000000
#define YOKAN_MODE_LUA_FILTER   0b0000010000000000
#define YOKAN_MODE_IGNORE_DOCS  0b0000100000000000
#define YOKAN_MODE_FILTER_VALUE 0b0001000000000000
